...
//---------------------------
  ...
  function buildCharts(sample) {
    ...
    d3.json("samples.json").then((data) => {
      ...
      // (Deliverable 3 step 1 - for gauge chart) Create a variable that filters the metadata array for the object with the desired sample number.
      var metadataArray = data.metadata.filter(chartObj => chartObj.id == sample);
    
      // 5. Create a variable that holds the first sample in the array.
      var chartResult = graphArray[0];
    
      // (Deliverable 3 step 2 - for gauge chart) Create a variable that holds the first sample in the metadata array.
      ...
      // (Deliverable 3 step 3 - for gauge chart) Create a variable that holds the washing frequency.
